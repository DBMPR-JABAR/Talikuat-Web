...
<div class="row">
    ...
    <div class="col-xl-6 col-md-6">
                    ...
                    <div class="card-block">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="rule_user" @if ( Auth::user()->id != 1) disabled @endif>
                                ...
                                @if ($rule->id == @$data->user_detail->rule_user_id)
        ...
        <div class="col-xl-6 col-md-6">
            ...
            <a href="{{ route('masterppk.index') }}"><button type="button" class="btn btn-danger waves-effect " data-dismiss="modal">Kembali</button></a>
            <button type="submit" class="btn btn-responsive btn-primary"><i class="fa fa-paper-plane"></i> Save</button>
        </form>
    </div>
</div>
