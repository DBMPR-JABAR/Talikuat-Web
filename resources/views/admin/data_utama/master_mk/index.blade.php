...
<div class="page-header">
    <h3 class="page-title">Data Manajemen Konstruksi</h3>
...
<div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Data Manajemen Konstruksi</h4>
                            ...
                            <tbody>
                                @foreach ($data as $no => $item)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if (Request::segment(3) != 'trash')
                                            <a type='button' href='{{ route('show.mastermk',$item->id) }}'  class='btn btn-sm btn-success waves-effect waves-light'><i class="mdi mdi-search-web menu-icon"></i></a>
                                            <a type='button' href='{{ route('edit.mastermk',$item->id) }}'  class='btn btn-sm btn-warning waves-effect waves-light'><i class="mdi mdi-table-edit menu-icon"></i></a>
                                            @else
...
<div class="modal-only">
            ...
            <div class="modal-content">
                <form action="{{route('store.mastermk')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title">Tambah Manajemen Konstruksi</h4>
                        <button
                            type="button"
                            class="close"
                            data-dismiss="modal"
    ...
    <div class="modal fade" id="delModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Pindahkan Data ke Sampah</h4>
                    <button
                        type="button"
                        class="close"
                        data-dismiss="modal"
...
<script>
    $(document).ready(function () {
        ...
        $("#delModal").on("show.bs.modal", function (event) {
            ...
            console.log(id);
            const url = `{{ url('admin/master_mk/trash/move_to_trash') }}/` + id;
            console.log(url);
            const modal = $(this);
        ...
        $("#Restore").on("show.bs.modal", function (event) {
            ...
            const id = link.data("id");
            console.log(id);
            const url = `{{ url('admin/master_mk/trash/restore') }}/` + id;
            console.log(url);
            const modal = $(this);
