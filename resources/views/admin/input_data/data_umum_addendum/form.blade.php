...
<div class="page-header">
    ...
    <h3 class="page-title"> @if(Request::segment(3) == 'addendum' and is_numeric(Request::segment(4))) Create @else Edit @endif Data Umum Addendum</h3>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="{{ route('masterppk.index') }}">Data Umum Adendum</a></li>

            @if(Request::segment(3) == 'addendum' and is_numeric(Request::segment(4)))
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header ">
                <h4 class="card-title">Data Umum Addendum</h4>
                    ...
                    <form action="{{route('store.dataumum')}}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="card-block">
                            <div class="form-group">
                                <label>Pemda</label>
                                <input type="text" name="pemda" id="pemda"
                            ...
                            <div class="form-group">
                                ...
                                <select name="kategori_paket_id" class="form-control" required disabled>
                                    <option selected >
                                        ...
                                        <div class="col-md-3 col-sm-3">
                                            <p>
                                                <input type="button"
                                                    ...
                                                    data-toggle="tooltip" title="Tambah Ruas" value="Tambah Ruas"
                                                    disabled>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" name="panjang_km" id="panjang_km"
                                    value="{{ @$data->panjang_km }}" placeholder="....Km" class="form-control" required
                                    autocomplete="off">
                                @error('panjang_km')
                                <div class="invalid-feedback" style="display: block; color:red">
                                    {{ $message }}
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" step="1" name="lama_waktu" id="lama_waktu"
                                    value="{{ @$data->lama_waktu }}" class="form-control" required autocomplete="off">
                                @error('lama_waktu')
                                <div class="invalid-feedback" style="display: block; color:red">
                                    {{ $message }}
                                </div>
