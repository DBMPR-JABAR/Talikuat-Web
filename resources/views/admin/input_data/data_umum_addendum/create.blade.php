...
<div class="page-header">
    <h3 class="page-title">
        @if(Request::segment(3) == 'addendum' and
        is_numeric(Request::segment(4))) Create @else Edit @endif Data Umum
        Addendum
    </h3>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="{{ route('masterppk.index') }}">Data Umum Adendum</a>
            </li>

            @if(Request::segment(3) == 'addendum' and
            is_numeric(Request::segment(4)))
                ...
                <div class="card-block">
                    ...
                    <div class="form-group">
                        ...
                        >
                            ...
                            @if($kategori->id == $data->kategori_paket_id)
