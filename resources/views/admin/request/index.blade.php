@extends('layout.index') @section('title','Request') 
@section('header')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">     
            <li class="breadcrumb-item active" aria-current="page">
                <a href="/Talikuat-Backend/public/admin/dashboard">Dashboard</a> / Request
            </li>
        </ol>
    </nav>
</div>
                ...
                >
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>FRM-01/SOP/DBMPR-1<br/>
                                2021-05-31</td>
                            <td>1 M Pekerjaan Penggantian Jembatan Ciroke Ruas Jalan Ciawigebang - Bts.Cirebon/Kuningan (Waled) Km.Cn. 58+420</td>
                            <td>Km.Cn.58+420<br/>
                                1.8.(2) - Jembatan Sementara<br/>
                                1.00 (LS)</td>
                                <td><img src="..." alt="..." class="img-thumbnail"></td>
                            <td>
                              <button type="button" class="btn btn-light" style="width: 100px !important; font-size: 13px !important;" data-toggle="modal" data-target="#exampleModalDetail" data-whatever="Detail :">Lihat</button>
                            </td> 
                            <td>Dokumen Berada di PPK</td>
                            <td>
                              <button type="button" class="btn btn-success" style="width: 100px !important; font-size: 13px !important;" data-toggle="modal" data-target="#exampleModalApproval" data-whatever="Approval :">Approval</button> 
                            </td>
                        </tr>
                    </tbody>
                </table>
...
<!-- Modal Approval -->
<div class="modal fade bd-example-modal-lg" id="exampleModalApproval" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h3 class="modal-title" id="exampleModalLabel">Request Approval</h3>
        ...
        <div class="modal-body ">
          ...
          <div class="card-body" style="display: block;">			
               <div class="form-group row">
                        ...
                        <label class="col-sm-2 col-form-label">Kegiatan / Paket</label><div class="col-sm-10">
                          <input type="text" class="form-control" id="kegiatan" name="kegiatan" value="" required="required" readonly="">
                <input id="unor" type="hidden" value="" class="form-control" name="unor">
                        </div>
                      </div>
               ...
               <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="date" class="form-control" id="diajukan_tgl" name="diajukan_tgl" value="" required="required" readonly="">
                        </div>
                      </div>
               ...
               <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="lokasi_sta" name="lokasi_sta" value="" required="required" readonly="">
                        </div>
                      </div>
               ...
               <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="jenis_pekerjaan" name="jenis_pekerjaan" value="" required="required" readonly="">
                        </div>
                      </div>
             ...
             <div class="form-group row">
                ...
                <div class="input-group mb-3">
                    <input type="text" class="form-control" id="perkiraan_volume" name="perkiraan_volume" value="" required="required" readonly="">
                </div>
              </div>
                      </div>
               ...
               <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="date" class="form-control" id="pelaksanaan_tgl" name="pelaksanaan_tgl" value="" required="required" readonly="">
                        </div>
                      </div>				  
                  ...
                  <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                      <table class="table table-bordered table-hover" id="invoiceItem1">	
                        ...
                        <td><input type="text" value="" name="bahan[]" id="bahan_1" class="form-control" autocomplete="off" readonly=""></td>
                        <td><input type="text" value="" name="volume_bahan[]" id="volume_bahan_1" class="form-control" autocomplete="off" readonly=""></td>
                        <td><input type="text" value="" name="satuan_bahan[]" id="satuan_bahan_1" class="form-control" autocomplete="off" readonly=""></td>
                        </tr>	
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              <label for="recipient-name" class="col-form-label">Direksi Lapangan :</label>
              <div class="input-group mb-3">
                <div class="custom-file">
                  <input type="file" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" accept="image/x-png,image/gif,image/jpeg,application/pdf">
                  <label class="custom-file-label" for="inputGroupFile01">Choose file</label>
                </div>               
              </div>
              <textarea class="form-control" id="message-text" placeholder="Catatan Direksi Lapangan"></textarea><br/>
              ...
              <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success">Kirim Approval</button>
              </div>
            </div>
            
            <div class="form-group">
              <label for="message-text" class="col-form-label">Pejabat Pembuat Komitmen (PPK) :</label>
              <div class="input-group mb-3">
                <div class="custom-file">
                  <input type="file" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" accept="image/x-png,image/gif,image/jpeg,application/pdf">
                  <label class="custom-file-label" for="inputGroupFile01">Choose file</label>
              ...
              <textarea class="form-control" id="message-text" placeholder="Catatan Pejabat Pembuata Komitmen (PPK)"></textarea><br/>
...
<div class="modal fade" id="exampleModalDetail" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Foto dan Catatan</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form>
          <div class="form-group">
            ...
            <textarea class="form-control" id="message-text" placeholder="Catatan Direksi Lapangan"></textarea>
          </div>
          <div class="form-group">
            <label for="message-text" class="col-form-label">Pejabat Pembuat Komitmen (PPK) :</label>
            <img src="..." class="rounded mx-auto d-block" alt="...">
            <textarea class="form-control" id="message-text" placeholder="Catatan Pejabat Pembuata Komitmen (PPK)"></textarea>
          </div>
        </form>
      </div>
      <div class="modal-footer">
