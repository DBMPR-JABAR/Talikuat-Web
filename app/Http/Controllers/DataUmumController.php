...
class DataUmumController extends Controller
{
  ...
  public function getLatestDataUmum() {
    ...
    $result = DB::table('data_umum')
                ->selectRaw('aksi, data_umum.id, konsultan_supervisi, lat, lat_akhir, lat_awal, lng, long_akhir, long_awal, nama_gs, nama_kegiatan, nama_ppk, nama_ruas_jalan, nama_se, nilai_kontrak, no_kontrak, no_spmk, opd, panjang, pemda, penyedia_jasa, pk, ppk, rab, rab1, rab2, rab3, ruas_jalan, GROUP_CONCAT(ruas_jalan) as ruas_jalan_concat, satuan_panjang, satuan_waktu, data_umum.segmen_jalan, sk, sm, tgl_input, tgl_kontrak, tgl_spmk, tgl_update, ul_jadual, ul_jaminan, ul_rencana, ul_spek, ul_spkmp, ul_spl, ul_spmk, ul_sppbj, unit, unor, user, waktu_pelaksanaan, wp')
